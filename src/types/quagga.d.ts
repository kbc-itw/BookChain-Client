...
// https://github.com/serratus/quaggaJS/blob/master/type-definitions/quagga.d.ts
// これがそのままだと動かないので、変更を加えている。
...
declare module 'quagga' {
    ...
    interface QuaggaJSResultCallbackFunction {
        (
            data: QuaggaJSResultObject | QuaggaJSResultObject[]
        ): void;
    }
    ...
    interface QuaggaJSResultCollector {
         ...
         */
        create?(collector: QuaggaJSResultCollector): QuaggaJSResultCollector;
